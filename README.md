...
<body>
    <div class="container">
        ...
        <div class="platform-info">
            <strong>Platform:</strong> Vercel Deployment<br>
            <strong>OAuth Client ID:</strong> Configured ✓<br>
            <strong>Domain:</strong> <span id="currentDomain">Đang xác định...</span>
        </div>
        ...
        <div class="login-section" id="loginSection">
            ...
            <div class="demo-option">
                <button class="btn debug-btn" onclick="switchToDemo()" style="width: auto; padding: 10px 20px;">
                    Demo Mode (Không cần đăng nhập)
                </button>
            </div>
        </div>
...
<script src="https://apis.google.com/js/api.js"></script>
    ...
    <script>
        // Cấu hình với OAuth Client ID đã có
        const CONFIG = {
        ...
        window.addEventListener('load', function() {
            debugLog('Trang đã load trên Vercel');
            
            // Hiển thị domain hiện tại
            document.getElementById('currentDomain').textContent = window.location.hostname;
            
            // Bắt đầu khởi tạo Google API
            initializeGoogleAPI();
        });
        ...
        function handleInitFailure() {
            ...
            showNotification(
                ...
                '• OAuth Client ID chưa cấu hình đúng domain\n' +
                '• Network/firewall issues\n' +
                '• Google APIs service down\n\n' +
                'Bạn có thể thử Demo Mode để test chức năng.',
                'error'
            );
            ...
            statusBox.innerHTML = `
                <div style="color: #721c24; margin-bottom: 15px;">
                    Không thể khởi tạo Google APIs
                </div>
